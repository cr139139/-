...
##### 1일차
* 자동차산업, 자율주행자동차, 미래스마트모빌리티 관련 강연
* 자율주행자동차의 제어 및 인지 파트 이론 설명
* 실습 1 - 모형자동차 조종 실습
##### 2일차
* 미적분과 기하 기초 지식으로 이해할 수 있는 수준
###### 1교시
* 횡방향 제어 이론 설명 및 과제 - gain time 조절하기
###### 2교시
* 종방향 제어 이론 설명 및 과제 - 감속 필요 거리 계산하기
* 뉴튼 운동 법칙의 실제 적용 사례
* 도로 경사나 타이어 마찰력, actuator delay 등의 영향도 있을 것으로 예상되지만 일단은 단순화하여 생각
* 센서 &rarr; 제동 컴퓨터 &rarr; 제동 명령 &rarr; 가속도 &rarr; 속도 &rarr; 위치
* 잡음 대책 : PWM 제어
* 서 있는 차량 뒤에 정지하는 경우와 감속하는 차량과의 추돌 방지 : 상대속도
* 대조군 baseline 과의 비교; 어떻게 바른 대조군을 설정할 것인가?
###### 3교시
* 실습 2 - 모형자동차로 위의 내용 실습 (1차 조별 평가)
##### 3일차
###### 1교시
* 인지분야 이론 설명 및 과제 - 차량과 사람, 신호등 인식하기
* 신경망에 대한 소개
* Forward predition 과 Backward propagation
* 고해상도 음성 또는 영상 자료 처리에 대한 신경망의 강점
* MNIST 실습
* "I am not a robot" 또는 ReCapcha 응용 가능 사례 소개
* 심층 신경망에 대한 소개
* 차량 사람 bitmap image 모음을 이용하여 신경망 훈련
###### 2교시
* 실습 3 - 모형자동차로 종/횡 제어 및 인식 실습 2차 조별 평가
#### 수업관리
* 수업 운영 방법 제시
